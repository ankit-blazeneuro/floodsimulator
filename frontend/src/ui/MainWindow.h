...
private:
    ...
    // Multi-Screen Root Workspace Stack (0: Simulation Map, 1: Analytics, 2: Help & Support, 3: Monitor)
    QStackedWidget* rootStack;
    AnalyticsWidget* analyticsScreen;
    HelpSupportWidget* helpScreen;
    MonitorWidget* monitorScreen;
    ...
    QPushButton* btnWorkspaceMonitor;
...
public:
    ...
    MonitorWidget* getMonitorScreen() const { return monitorScreen; }
