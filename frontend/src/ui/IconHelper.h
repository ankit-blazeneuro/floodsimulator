...
public:
    ...
    static QIcon temperature(const QColor& color = QColor(251, 146, 60), int size = 18) {
        return get("temperature", color, size);
    }
    static QIcon heatMap(const QColor& color = QColor(251, 146, 60), int size = 18) {
        return get("temperature", color, size);
    }
    static QIcon waves(const QColor& color = QColor(34, 211, 238), int size = 18) {
        return get("waves", color, size);
    }
};
